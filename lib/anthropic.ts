...
For EVERY section you draft, also make a judgment call: is the underlying source material for this section merely present, or is it actually thin - a fact or method stated with no reasoning connecting it to the client's goals, or a one-line scope with no real detail? This is a qualitative judgment about DEPTH OF REASONING, not general completeness or wordiness. If thin, mark the section "scanty" and give a one-sentence scanty_reason explaining specifically what's missing (e.g. "recommended approach is named but no stated reasoning connects it to the client's stated goals"). If the source material is genuinely sufficient to draft a real section, mark it "generated" with scanty_reason null.
